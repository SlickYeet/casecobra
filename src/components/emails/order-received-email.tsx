        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We&apos;re preparing everythign for delivery and will notify you
              once your package has been shipped. Delivery usually takes 3-5
              business days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions regarding your order, please feel free
              to contact us with your order number. We&apos;re here to help.
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              <Text
                ...
                this email, won&apos;t be able to see it.)
              </Text>
            </Row>
            <Row>
              <Text style={footer.text}>
                &copy; 2024 CaseCobra, Inc. All rights reserved.
              </Text>
            </Row>
          </Section>
        </Container>
